// Sketch F
let sketchF = new p5(( sketch ) => {
    let x = 0;
    let y = 0;

    sketch.setup = () => {
        let canvas = sketch.createCanvas(300, 300);
        canvas.parent('sketchF'); // Set the parent to the grid item with id 'grid-item-2'
    };
    ...
    sketch.draw = () => {
        ...
        sketch.text("chaotic neutral", 120, 20); // Display text at coordinates (20, 20)
    };
});
