// Sketch G
let sketchG = new p5(( sketch ) => {
    let x = 0;
    let y = 0;

    sketch.setup = () => {
        let canvas = sketch.createCanvas(300, 300);
        canvas.parent('sketchG'); // Set the parent to the grid item with id 'grid-item-2'
    };
    ...
    sketch.draw = () => {
        ...
        sketch.text("lawful good", 120, 20); // Display text at coordinates (20, 20)
    };
});
